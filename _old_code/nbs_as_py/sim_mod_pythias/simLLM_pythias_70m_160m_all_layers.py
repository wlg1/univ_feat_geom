...
for i in range(0, 12): # 0, 12
    ...
    with torch.inference_mode():
        hidden_state_2 = outputs_2.hidden_states[i].to("cuda")
...
layer_to_dictscores_1to1 = {0: {'mean_actv_corr': 0.1581693401967641,
  '1-1 jaccard_paired': 0.017160607459885065,
  '1-1 jaccard_unpaired': 0.01769416475298828,
  '1-1 svcca_paired': 0.004641090247973133,
  '1-1 svcca_unpaired': 0.017825349566144164},
 1: {'mean_actv_corr': 0.18898305935241902,
  '1-1 jaccard_paired': 0.023430596868950538,
  '1-1 jaccard_unpaired': 0.02713881132088198,
  '1-1 svcca_paired': 0.06699936396165086,
  '1-1 svcca_unpaired': 0.04832884888591569},
 2: {'mean_actv_corr': 0.22581030948398015,
  '1-1 jaccard_paired': 0.03239539401603863,
  '1-1 jaccard_unpaired': 0.03231784550347875,
  '1-1 svcca_paired': 0.047768668065607756,
  '1-1 svcca_unpaired': 0.02782597422578975},
 3: {'mean_actv_corr': 0.22255845934463045,
  '1-1 jaccard_paired': 0.04381959464872226,
  '1-1 jaccard_unpaired': 0.036682888728670995,
  '1-1 svcca_paired': 0.05248890149540392,
  '1-1 svcca_unpaired': 0.05277668460554209},
 4: {'mean_actv_corr': 0.21717668059864081,
  '1-1 jaccard_paired': 0.03863649393835152,
  '1-1 jaccard_unpaired': 0.04242202729044834,
  '1-1 svcca_paired': 0.008332725963144539,
  '1-1 svcca_unpaired': 0.053378658139464366},
 5: {'mean_actv_corr': 0.2144443414193423,
  '1-1 jaccard_paired': 0.04420364637082903,
  '1-1 jaccard_unpaired': 0.043848160152218776,
  '1-1 svcca_paired': 0.05793529281554803,
  '1-1 svcca_unpaired': 0.05669640131150265},
 6: {'mean_actv_corr': 0.20398066137568094,
  '1-1 jaccard_paired': 0.038491627550850546,
  '1-1 jaccard_unpaired': 0.04664110267763019,
  '1-1 svcca_paired': 0.03660206956583964,
  '1-1 svcca_unpaired': 0.09267102537807065},
 7: {'mean_actv_corr': 0.20752148512595645,
  '1-1 jaccard_paired': 0.05077843248221754,
  '1-1 jaccard_unpaired': 0.0609896024057614,
  '1-1 svcca_paired': 0.0033241017336225853,
  '1-1 svcca_unpaired': 0.04592455143573271},
 8: {'mean_actv_corr': 0.206186333190999,
  '1-1 jaccard_paired': 0.062283047190167924,
  '1-1 jaccard_unpaired': 0.06178395800106327,
  '1-1 svcca_paired': 0.011727099617977337,
  '1-1 svcca_unpaired': 0.03142745352238406},
 9: {'mean_actv_corr': 0.2044408888129207,
  '1-1 jaccard_paired': 0.05764758229760248,
  '1-1 jaccard_unpaired': 0.06038189303181225,
  '1-1 svcca_paired': 0.04358943823623867,
  '1-1 svcca_unpaired': 0.09154610562718939},
 10: {'mean_actv_corr': 0.18758639571024105,
  '1-1 jaccard_paired': 0.061428080003931386,
  '1-1 jaccard_unpaired': 0.05568332596196372,
  '1-1 svcca_paired': 0.017216381785704966,
  '1-1 svcca_unpaired': 0.10247118734157756},
 11: {'mean_actv_corr': 0.17689472717271806,
  '1-1 jaccard_paired': 0.07642038863689089,
  '1-1 jaccard_unpaired': 0.06136680906552745,
  '1-1 svcca_paired': 0.1414280454603996,
  '1-1 svcca_unpaired': 0.1342785141083091}}
...
def plot_svcca_byLayer(layer_to_dictscores):
    ...
    paired_values = [layer_to_dictscores[i]['1-1 svcca_paired'] for i in range(0, 12)]
    unpaired_values = [layer_to_dictscores[i]['1-1 svcca_unpaired'] for i in range(0, 12)]
    ...
    ax.set_ylabel('SVCCA')
    ax.set_title(f'LLMs comparison by Pythia 70m MLP{mod_A_layer} vs 160m MLP Layers')
    ax.set_xticks(x)
...
def plot_js_byLayer(layer_to_dictscores):
    ...
    ax.set_title(f'LLMs comparison by Pythia 70m MLP{i} vs 160m MLP Layers')
    ax.set_xticks(x)
    ax.set_xticklabels(layers)
    ax.set_ylim(0, 1)  # Ensuring y-axis is scaled from 0 to 1
    ax.legend()
...
layer_to_dictscores_1to1 = {0: {'mean_actv_corr': 0.12152422389287192,
  '1-1 jaccard_paired': 0.017153009729327186,
  '1-1 jaccard_unpaired': 0.021762665325200693,
  '1-1 svcca_paired': 0.10883674180932282,
  '1-1 svcca_unpaired': 0.0504130678108786},
 1: {'mean_actv_corr': 0.1836301740258932,
  '1-1 jaccard_paired': 0.02560100122214098,
  '1-1 jaccard_unpaired': 0.027579676850022383,
  '1-1 svcca_paired': 0.03973173770880937,
  '1-1 svcca_unpaired': 0.06450442374530442},
 2: {'mean_actv_corr': 0.26229201509462047,
  '1-1 jaccard_paired': 0.0345356249495683,
  '1-1 jaccard_unpaired': 0.0338465156476279,
  '1-1 svcca_paired': 0.12541731353713606,
  '1-1 svcca_unpaired': 0.05878778996748368},
 3: {'mean_actv_corr': 0.2972187085833866,
  '1-1 jaccard_paired': 0.042842484846328126,
  '1-1 jaccard_unpaired': 0.038973761313357766,
  '1-1 svcca_paired': 0.0028529951615103777,
  '1-1 svcca_unpaired': 0.06759178909899546},
 4: {'mean_actv_corr': 0.3064633062264572,
  '1-1 jaccard_paired': 0.041466203481639756,
  '1-1 jaccard_unpaired': 0.03876285750277378,
  '1-1 svcca_paired': 0.04389613793799146,
  '1-1 svcca_unpaired': 0.08583752476377512},
 5: {'mean_actv_corr': 0.303408495063195,
  '1-1 jaccard_paired': 0.04330010929532817,
  '1-1 jaccard_unpaired': 0.039064479889224187,
  '1-1 svcca_paired': 0.09821767350999612,
  '1-1 svcca_unpaired': 0.06592508053756457},
 6: {'mean_actv_corr': 0.2738316658360418,
  '1-1 jaccard_paired': 0.03269319096843873,
  '1-1 jaccard_unpaired': 0.03153445833885842,
  '1-1 svcca_paired': 0.11609504101857317,
  '1-1 svcca_unpaired': 0.05790665111639722},
 7: {'mean_actv_corr': 0.27520556027108495,
  '1-1 jaccard_paired': 0.029587650304447283,
  '1-1 jaccard_unpaired': 0.030842462864816844,
  '1-1 svcca_paired': 0.07814599076484215,
  '1-1 svcca_unpaired': 0.04928602510169213},
 8: {'mean_actv_corr': 0.2893398932743973,
  '1-1 jaccard_paired': 0.04150996322230765,
  '1-1 jaccard_unpaired': 0.0382051654996156,
  '1-1 svcca_paired': 0.1344542465360181,
  '1-1 svcca_unpaired': 0.06448739502199824},
 9: {'mean_actv_corr': 0.27667572833403636,
  '1-1 jaccard_paired': 0.035282852240106057,
  '1-1 jaccard_unpaired': 0.034076095812286135,
  '1-1 svcca_paired': 0.006028421282839691,
  '1-1 svcca_unpaired': 0.0592203057407083},
 10: {'mean_actv_corr': 0.25750744430115446,
  '1-1 jaccard_paired': 0.02319202407079433,
  '1-1 jaccard_unpaired': 0.024128552823105796,
  '1-1 svcca_paired': 0.12596872254842692,
  '1-1 svcca_unpaired': 0.041386209790157655},
 11: {'mean_actv_corr': 0.24822615394562794,
  '1-1 jaccard_paired': 0.020917678812415658,
  '1-1 jaccard_unpaired': 0.02306398642827951,
  '1-1 svcca_paired': 0.18443837867152382,
  '1-1 svcca_unpaired': 0.0943912818543094}}
