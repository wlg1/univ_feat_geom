...
# model_2 = AutoModelForCausalLM.from_pretrained("google/gemma-2-9b")
...
acts_filename = 'gemma2_9b_LLM_actvs.pkl'
with open(acts_filename, 'wb') as f:
...
layer_id = 22
target_act = gather_residual_activations(model_2, layer_id, inputs['input_ids'])
