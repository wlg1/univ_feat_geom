...
weight_matrix_np = model.gpt_neox.layers[4].mlp.dense_4h_to_h.weight
...
weight_matrix_2 = model_2.gpt_neox.layers[4].mlp.dense_4h_to_h.weight
...
representational_similarity_analysis(weight_matrix_np[highest_correlations_indices_AB], weight_matrix_2, "nd")
