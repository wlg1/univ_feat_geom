...
svcca(mlp_weights.detach().numpy().T, mlp_weights_2.detach().numpy().T, "nd")
...
svcca(mlp_weights.detach().numpy().T[highest_correlations_indices], mlp_weights_2.detach().numpy().T, "nd")


# In[46]:


svcca(mlp_weights.detach().numpy().T, mlp_weights_2.detach().numpy().T[highest_correlations_indices], "nd")
...
jaccard_similarity(mlp_weights.detach().numpy().T, mlp_weights_2.detach().numpy().T)


# In[51]:


jaccard_similarity(mlp_weights.detach().numpy().T[highest_correlations_indices], mlp_weights_2.detach().numpy().T)


# In[53]:


jaccard_similarity(mlp_weights.detach().numpy().T, mlp_weights_2.detach().numpy().T[highest_correlations_indices])
