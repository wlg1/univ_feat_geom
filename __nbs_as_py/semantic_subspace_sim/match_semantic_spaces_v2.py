...
def get_mixed_feats(fList_model_B, corr_inds, keywords):
    ...
    for kw in keywords:
        ...
        modA_feats = get_values_from_indices(modB_feats, corr_inds)
...
mixed_modA_feats, mixed_modB_feats = get_mixed_feats(keywords['numeric'])
